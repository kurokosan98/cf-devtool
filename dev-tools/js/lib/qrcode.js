const QR = (() => {
  ...
  const ALIGN = [
    ...
    [6,32,34],[6,34,38],[6,36,42],[6,38,46],
    [6,40,50],[6,42,54],[6,44,58],[6,46,62],
    [6,48,66],[6,50,70],[6,52,74],[6,54,78],
    [6,56,82],[6,58,86],[6,60,90],[6,62,94],
    [6,64,98],[6,66,102],[6,68,106],[6,70,110],
    [6,72,114],[6,74,118],[6,76,122],[6,78,126],
    [6,80,130],[6,82,134],[6,84,138],[6,86,142],
    [6,88,146],[6,90,150],[6,92,154],[6,94,158],
    [6,96,162],[6,98,166],
  ];
  ...
  function makeMatrix(ver, ecIdx, data) {
    ...
    const aps = ALIGN[ver - 1];
    if (aps && aps.length > 0) {
      for (let i = 0; i < aps.length; i++) {
        for (let j = 0; j < aps.length; j++) {
          const r = aps[i], c = aps[j];
